...
class T(unittest.TestCase):
 def test_domain_result(self):
  data=json.loads("[{\"name\":\"Грант A\",\"due_on\":\"2026-08-20\",\"done\":false},{\"name\":\"Грант B\",\"due_on\":\"2026-09-20\",\"done\":false}]"); result=x.run(data,'2026-08-18',7); self.assertTrue(result is not None)
